...
EXECUTE msdb.dbo.sysmail_add_account_sp
    ...
    @email_address = 'ewhserver1808@hsmove.com',
    @display_name = 'SQL Admin Account ewhserver1808',
    @mailserver_name = '10.10.240.11';
...
( NAME = N'_DBAMain_Data', 
   FILENAME = N'F:\db\_DBAMain_Data.MDF',
   SIZE = 5120KB,
   MAXSIZE = UNLIMITED,
   FILEGROWTH = 10%)
 LOG ON
( NAME = N'_DBAMain_Log',
   FILENAME = N'F:\db\_DBAMain_Log.LDF' ,
   SIZE = 3072KB ,
   MAXSIZE = 2048GB ,
   FILEGROWTH = 10%)
GO
