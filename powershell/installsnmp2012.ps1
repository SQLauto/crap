#Variables
$pmanagers = @("0.0.0.0") # ADD YOUR MANAGER(s) in format @("manager1","manager2")
$CommString = @("Community") # ADD YOUR COMM STRING(s) in format @("Community1","Community2")
...
reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\services\SNMP\Parameters\PermittedManagers" /v 1 /t REG_SZ /d Null /f | Out-Null
